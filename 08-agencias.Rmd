...
#   tab_footnote(md("**Fuente**: Dirección Nacional de Mercados y Estadística (DNMyE) en base a datos de la Dirección Nacional de Agencias de Viajes.")) %>% 
#   fmt_percent(columns = var, decimals = 1, dec_mark = ",") %>%  
#   tab_caption(glue("Agencias de viajes habilitadas por tipo de categoría. Total país. Años 2004-2015/{anio}."))
...
#agencias_suc <- read_sheet("https://docs.google.com/spreadsheets/d/1wJ4rrbvBFd1sgX-Ibo12QUC2QR-wG0et6bfshNWcx3U/edit#gid=0")

#write_csv(agencias_suc, "agencias_sucursales.csv")
